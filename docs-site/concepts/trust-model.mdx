...
description: "Trust boundaries, sandbox policies, authentication chain, and security posture for local-first operation."
icon: "shield-halved"
---
...
flowchart TD
    S["Risoluto\nOrchestrator"] -->|"launches + constrains"| C["Codex\nAI Agent"]
