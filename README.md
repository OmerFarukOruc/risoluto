...
> The north star — identity, dogfood bar, quality + reliability pillars, and explicitly rejected scope — lives in **[docs/strategy/VISION.md](docs/strategy/VISION.md)**. Operator ideas in flight are captured in **[docs/strategy/IDEAS.md](docs/strategy/IDEAS.md)**; deferred strategic questions in **[docs/strategy/OPEN_QUESTIONS.md](docs/strategy/OPEN_QUESTIONS.md)**.
