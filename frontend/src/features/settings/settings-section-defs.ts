      ...
      fields: [
        {
          ...
          group: "Safety",
          groupDescription:
            "Decide which actions need explicit approval before they run. Risoluto's overnight-solo posture defaults to Never (auto-approve) so the agent is not blocked while you sleep — pair it with a tight sandbox mode below.",
          options: [
          ...
          hint: "Controls when the agent pauses to ask for approval. Never is the default for unattended runs.",
          defaultValue: "never",
        },
        {
