...
const ICONS = {
  ...
  chevronDown: filledIcon("M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"),
  ...
  issueDetail: filledIcon("M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"),
  issueLogs: filledIcon("M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"),
  ...
  outcomeSuccess: strokeIcon([
    { tag: "circle", attrs: { cx: "12", cy: "12", r: "10" } },
    { tag: "polyline", attrs: { points: "9 12 11 14 15 10" } },
  ]),
  outcomeError: strokeIcon([
    { tag: "circle", attrs: { cx: "12", cy: "12", r: "10" } },
    { tag: "line", attrs: { x1: "15", y1: "9", x2: "9", y2: "15" } },
    { tag: "line", attrs: { x1: "9", y1: "9", x2: "15", y2: "15" } },
  ]),
  outcomeTimeout: strokeIcon([
    { tag: "circle", attrs: { cx: "12", cy: "12", r: "10" } },
    { tag: "polyline", attrs: { points: "12 6 12 12 16 14" } },
  ]),
  outcomeStall: strokeIcon([
    {
      tag: "path",
      attrs: { d: "M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" },
    },
  ...
  outcomeCancelled: strokeIcon([
    { tag: "circle", attrs: { cx: "12", cy: "12", r: "10" } },
    { tag: "line", attrs: { x1: "4.93", y1: "4.93", x2: "19.07", y2: "19.07" } },
  ]),
  eventConfig: strokeIcon([
    { tag: "circle", attrs: { cx: "12", cy: "12", r: "3" } },
    {
      tag: "path",
      attrs: {
  ...
  eventPlay: filledIcon("M8 5v14l11-7z"),
  eventAlert: strokeIcon([
    { tag: "circle", attrs: { cx: "12", cy: "12", r: "10" } },
