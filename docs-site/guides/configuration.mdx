...
description: "Complete reference for all Risoluto configuration options — server, tracker, agent, codex, workspace, sandbox, and notifications."
icon: "gear"
mode: "wide"
---
...
1. **Built-in defaults** — from Zod schemas in `src/config/schemas/`
