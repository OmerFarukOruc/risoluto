  ...
  return [
    {
      ...
      startHere: true,
      title: "Tracker",
      description: "Connect Risoluto to your issue tracker and define which states mean 'in progress' vs 'done'.",
      badge: "Start here",
      prefixes: ["tracker"],
      ...
      fields: [
        ...
        },
        {
          ...
          groupDescription: "Tell Risoluto which tracker states mean an issue is ready or in progress.",
    ...
    },
    {
      ...
      description: "Choose which AI model Risoluto uses, how it authenticates, and where API requests go.",
      badge: "Core runtime",
      ...
      fields: [
        ...
        },
        {
          ...
          groupDescription:
            "How the agent authenticates with the model provider. Credentials are read from the auth directory (default: ~/.codex/auth.json).",
          options: [
            { value: "api_key", label: "API key (from env var or auth.json)" },
            { value: "openai_login", label: "OpenAI login (browser-based)" },
          ],
          hint: "API key reads from OPENAI_API_KEY env var or ~/.codex/auth.json. OpenAI login uses browser auth flow.",
        ...
        },
        {
          ...
          tier: "expert",
          group: "Authentication",
          hint: "Directory containing auth.json with credentials. Default: ~/.codex",
          defaultValue: "~/.codex",
        },
        {
    ...
    },
    {
      ...
      title: "Sandbox",
      description:
        "Control how safely Risoluto runs code — set container image, security restrictions, and resource limits.",
      ...
      fields: [
        {
          ...
          hint: "Controls when the agent pauses to ask for human approval.",
          defaultValue: "never",
        },
        {
    ...
    },
    {
      ...
      groupId: SECTION_GROUPS.AGENT.id,
      title: "Agent",
      description: "Set how many tasks Risoluto runs in parallel, how long each can take, and when to retry.",
      badge: "Core runtime",
      prefixes: ["agent"],
    ...
    },
    {
      ...
      description: "Tune how long Risoluto waits for the agent process at each lifecycle stage.",
      badge: "Performance",
      prefixes: [
        "codex.command",
      ...
      fields: [
        {
          ...
          kind: "text",
          tier: "standard",
          hint: "Binary Risoluto invokes to run agents.",
    ...
    },
    {
      ...
      description: "Connect Risoluto to your GitHub repos and configure automation settings.",
      badge: "Integration",
    ...
    },
    {
      ...
      mode: "advanced",
      title: "Credentials",
      description: "Store encrypted API keys and tokens that Risoluto needs to connect to external services.",
      badge: "Security",
      prefixes: ["secrets"],
