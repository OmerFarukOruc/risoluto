...
title: FAQ
sidebarTitle: FAQ
description: "Frequently asked questions about Risoluto — what it is, privacy, models, Docker, failure handling, and more."
...
<AccordionGroup>
  ...
  <Accordion title="Does my code leave my machine?">
    **No.** Risoluto runs entirely on your local machine or a VDS you control. There is no Risoluto cloud service, SaaS backend, or telemetry.
